...
module.exports = __toCommonJS(keycloak_exports);
...
function stringifyQueryParams(params) {
  return new URLSearchParams(Object.entries(params).filter((param) => param[1] !== void 0)).toString();
}
...
var Agent = class {
  ...
  request({ method, path = "", urlParamKeys = [], queryParamKeys = [], catchNotFound = false, keyTransform, payloadKey, returnResourceIdInLocationHeader, ignoredKeys, headers }) {
    return async (payload = {}, options) => {
      ...
      const queryParams = queryParamKeys ? pick_default(payload, queryParamKeys) : null;
  ...
  updateRequest({ method, path = "", urlParamKeys = [], queryParamKeys = [], catchNotFound = false, keyTransform, payloadKey, returnResourceIdInLocationHeader, headers }) {
    return async (query = {}, payload = {}) => {
      const baseParams = this.getBaseParams?.() ?? {};
      const queryParams = queryParamKeys ? pick_default(query, queryParamKeys) : null;
      const allUrlParamKeys = [...Object.keys(baseParams), ...urlParamKeys];
      const urlParams = {
        ...baseParams,
  ...
  async requestWithParams({ method, path, payload, urlParams, queryParams, catchNotFound, payloadKey, returnResourceIdInLocationHeader, headers }) {
    ...
    try {
      const res = await import_axios.default.default(requestConfig);
      ...
      if (import_axios.default.default.isAxiosError(err) && err.response?.status === 404 && catchNotFound) {
        return null;
      }
      throw err;
    }
...
// node_modules/@keycloak/keycloak-admin-client/lib/resources/sessions.js
...
var defaultBaseUrl = "http://127.0.0.1:8080";
...
var getToken = async (settings) => {
  ...
  const { data } = await import_axios2.default.default.post(url, payload, config);
...
var KeycloakAdminClient = class {
  constructor(connectionConfig) {
    this.baseUrl = connectionConfig && connectionConfig.baseUrl || defaultBaseUrl;
    this.realmName = connectionConfig && connectionConfig.realmName || defaultRealm;
